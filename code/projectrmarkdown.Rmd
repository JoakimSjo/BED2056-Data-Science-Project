...
Police-Related fatality data set from Fatal Encounters: https://docs.google.com/spreadsheets/d/1dKmaV_JiWcG8XBoRgP8b4e9Eopkpgt7FL7nyspvzAsE/edit#gid=0

Population data set from the United States Census Bureau:
2000-2010: https://www2.census.gov/programs-surveys/popest/datasets/2000-2010/intercensal/county/co-est00int-sexracehisp.csv
2010-2019: https://www2.census.gov/programs-surveys/popest/tables/2010-2019/state/asrh/sc-est2019-alldata6.csv
-->
...
<iframe style="width: 915px; height: 515px; max-width: 100%; max-height: calc((100vw - 40px) / (16/9));" width="560" height="315" src="https://www.youtube.com/embed/xJ9KLY8WT6w" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
...
#### Protests
Information about when protests occurred and the background behind these protests is obtained from an article from Bloomberg News written in June 2020.^[https://www.bloomberg.com/news/articles/2020-06-09/a-history-of-protests-against-police-brutality].
...
The next goal is to analyze the difference in fatality rates between races for the past 20 years, and determine if protests have had an effect on any of them. 
...
The next graph examines the number of fatalities per million people of each race. This is done by finding the total number of fatalities by race and the total population of each race. The number of fatalities per million people is calculated by dividing the number of fatalities by the population of a specific race, and multiplying by a million. This graph only includes White, African-American, Asian, and Native American since those are the only races that are included in both the Fatality and the Population data frame. \
```{r code_pop_races}
...
This next plot shows a similar point as Figure 4, except focused on 2019. For each race, their percentage of fatalities and their percentage of the population that they take up is visualized. 
```{r code_bar_plot}
